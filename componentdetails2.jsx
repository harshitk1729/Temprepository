...
function ComponentDetails() {
  ...
  const ComponentTab = ({ component }) => (
    <table className="details-table">
      <tbody>
        ...
        <tr>
          <th>Version</th>
          <td>{component.componentDTO.lockVersion}</td>
        </tr>
            ...
            <tbody>
              {specs.map((spec, index) => (
                <tr key={index}>
                  ...
                  <td>
                    {spec.commentsNew && spec.comments.includes(spec.commentsNew)
                      ? spec.comments.replace(spec.commentsNew, '').trim()
                      : spec.comments}
                  </td>
                </tr>
              ))}
  ...
  const DrsTab = ({ drs }) => {
    const [activeSubTab, setActiveSubTab] = useState('active'); // Add this state

    // Separate rules into active and retired
